...
---
import BetterPSOViewer from '@site/src/components/BetterPSOViewer';
...
A Particle Swarm Optimisation visualiser that makes the algorithm's behavior easy to inspect, explain, and teach.
